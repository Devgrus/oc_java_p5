...
public class FloodServiceTest {
    ...
    public void getResidentListByStationsNumbersTest() {
        ...
        fireStationList.add(new FireStation("30 ccc", 2));
        fireStationList.add(new FireStation("40 ddd", 2));
    ...
    @Test
    public void getResidentListByStationsNumbersTestFireStationListIsEmpty() {
        //given

        //when
        when(fireStationRepository.findFireStationsByStation(any())).thenReturn(new ArrayList<>());

        //then
        assertThat(floodService.getResidentListByStationsNumbers(List.of(1, 2))).isNull();
